...
# sorted_snow = sorted(dataset, key=lambda d:d['snow'], reverse = True)
# pprint.pp(sorted_snow)
...
sorted_snow_wind = sorted(dataset, key = lambda day: (day['snow'], day['awnd']))

pprint.pp(sorted_snow_wind)